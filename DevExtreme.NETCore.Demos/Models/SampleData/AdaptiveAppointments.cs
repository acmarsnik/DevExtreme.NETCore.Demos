...
namespace DevExtreme.NETCore.Demos.Models.SampleData {
    public partial class SampleData {
        public static List<AdaptiveAppointment> AdaptiveAppointments {
            get {
                return new List<AdaptiveAppointment> {
                    ...
                    new AdaptiveAppointment {
                        ...
                        EndDate = new DateTime(2017, 5, 5, 11, 15, 0)
                    },
                    new AdaptiveAppointment {
                    ...
                    new AdaptiveAppointment {
                        ...
                        EndDate = new DateTime(2017, 5, 22, 12, 0, 0)
                    },
                    new AdaptiveAppointment {
