            ...
            new {
                ...
                features = new[] {
                    new {
                        ...
                        properties = new {
                            url = "../../images/VectorMap/Storm.png",
                            text = "New York"
                        }
                    },
                    new {
                        ...
                        properties = new {
                            url = "../../images/VectorMap/Cloudy.png",
                            text = "Washington"
                        }
                    },
                    new {
                    ...
                    new {
                        ...
                        properties = new {
                            url = "../../images/VectorMap/PartlyCloudy.png",
                            text = "Oklahoma City"
                        }
                    },
                    new {
                    ...
                    new {
                        ...
                        properties = new {
                            url = "../../images/VectorMap/Sunny.png",
                            text = "Houston"
                        }
                    },
                    new {
